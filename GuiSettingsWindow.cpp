...
#define UI_MAPPING(X)                                                \
  ...
  X("rb_sessionlog_askuser", logxfovr, LGXF_ASK__)                   \
  ...
  /* */                                                              \
  X("rb_fnkeys_vt100", app_cursor, true)                             \
