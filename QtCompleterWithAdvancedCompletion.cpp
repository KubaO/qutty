...
bool QtCompleterWithAdvancedCompletion::eventFilter(QObject *o, QEvent *e) {
  ...
  if (o != popuplist) return QObject::eventFilter(o, e);
  ...
  switch (e->type()) {
    case QEvent::KeyPress: {
      ...
      switch (key) {
        ...
        case Qt::Key_Tab:
          popuplist->hide();
          if (curIndex.isValid()) slot_completerComplete(curIndex);
          break;

        case Qt::Key_F4:
          if (ke->modifiers() & Qt::AltModifier) popuplist->hide();
          break;
